...
plugin supports custom user-defined rules.
...
- **Style:** Allows you to configure the styling of text in notes: text
  alignment, line height, space between characters and words, indentation, etc.
...
| "текст"                       | «текст»                     | Standard typography quotes        |
| "текст" "текст" "текст"       | «текст „текст“ текст»       | Nested quotes                     |
...
| Initials (И. И. Иванов)       | Narrow space (И. И. Иванов) | Compact initials formatting       |
...
| Ligatures (fi / fl)   | ﬁ, ﬂ               | Typographic ligatures       |
...
- **Стили:** позволяет настроить стилизацию текста заметок: выравнивание текста,
  высота строк, расстояние между символами и словами, отступы и прочее.
